...
const Hero = () => {
  ...
  return (
    <section className="min-h-[85vh] flex items-center justify-center relative z-10 bg-[#0d0d11] py-28 px-6 sm:px-10 lg:px-20">
              ...
              >
                {heroContent[index].icon && (
                  (() => {
                    ...
                    return <IconComponent className={`w-12 h-12 bg-gradient-to-r ${heroContent[index].color || 'from-[#00ff41] via-[#00f0ff] to-[#ff00ff]'} bg-clip-text text-transparent`} />;
                  })()
                )}
              </motion.div>

              <motion.h1
                className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 bg-gradient-to-r from-indigo-400 to-purple-500 text-transparent bg-clip-text"
