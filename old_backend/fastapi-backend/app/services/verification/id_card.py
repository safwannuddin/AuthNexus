...
# Let pytesseract find Tesseract using the system PATH
# Only set explicitly if needed and exists
...
class IDCardVerificationService(BaseVerificationService):
    def __init__(self):
        super().__init__()
        self.supported_types = ["id_card", "identity_card", "id"]
    ...
    def _find_expiry_date(self, text: str) -> bool:
        ...
        expiry_indicators = ["expiry date", "expired", "date of expiry", "valid until"]
    ...
    def _find_authority(self, text: str) -> bool:
        ...
        """
        # Look for common issuing authority indicators
        authority_indicators = ["issuing authority", "issued by", "department", "authority"]
